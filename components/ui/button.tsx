...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-success text-foreground shadow hover:bg-success/90 focus-visible:ring-success",
        destructive:
          "bg-error text-neutral-50 shadow-sm hover:bg-error/90 focus-visible:ring-error",
        outline:
          "border border-muted bg-background shadow-sm hover:bg-muted/50 focus-visible:ring-muted",
        secondary:
          "bg-secondary text-foreground shadow-sm hover:bg-secondary/80 focus-visible:ring-secondary",
        ghost:
          "hover:bg-muted/50 hover:text-foreground focus-visible:ring-muted",
